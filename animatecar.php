...
<html>
    ...
    <body>
        ...
        <div class="road"></div>
        <div class="task">Make The Car Finish The Race</div>
        <div class="optionone">
            <br>
            <center>Create An Animation And Apply It</center>
            <form method="POST">
                <input type="submit" name="one" id="one" formaction="finish.php">
            </form>
        </div>
        <div class="optiontwo">
            <br>
            <center>Use The Arrow Keys</center>
            <form method="POST">
                <input type="button" name="two" id="two" formaction="wrong.php">
            </form>
        </div>
        <div class="optionthree">
            <br>
            <center>Apply A Direction To The Car</center>
            <form method="POST">
                <input type="button" name="three" id="three" formaction="wrong.php">
            </form>
        </div>
        ...
        <style>
            ...
            .optiontwo:active, .optionthree:active {
