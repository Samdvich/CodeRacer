...
<html>
    ...
    <body>
        ...
        <div class="road"></div>
        <div class="task">Move The Car Onto The Road</div>
        <div class="optionone">
            <br>
            <center>Create A Padding</center>
            <form method="POST">
                <input type="button" name="one" id="one" formaction="wrong.php">
            </form>
        </div>
        <div class="optiontwo">
            <br>
            <center>Drag And Drop It</center>
            <form method="POST">
        ...
        <div class="optionthree">
            <br>
            <center>Create A Margin</center>
            <form method="POST">
                <input type="submit" name="three" id="three" formaction="animatecar.php">
            </form>
        </div>
        ...
        <style>
            ...
            .optionone:active, .optiontwo:active {
